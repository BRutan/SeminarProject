...
def PullAllData():
    ...
    if not hasattr(args, 'ticker') and not hasattr(args, 'termFile'):
        errs.append('Ticker or termFile must be specified.')
    elif hasattr(args, 'ticker') and not hasattr(args, 'searchTerms'):
        errs.append('If using ticker, must specify searchTerms.')
    elif hasattr(args, 'ticker') != hasattr(args, 'termFile'):
        errs.append('Only one of ticker, termFile must be specified.')
